  ...
  return (
    <div className="csu">
      <div className="csu__card">
        <h1 className="csu__title">Welcome to Star SVS</h1>
        <p className="csu__subtitle">Find trusted professionals near you.</p>
        ...
        <div className="csu__divider"><span>or</span></div>
        ...
        <p className="csu__login">
          Already have an account? <Link to="/worker/signup">Log in</Link>
        </p>
