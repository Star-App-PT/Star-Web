        ...
        <div className="wd__layout">
          <aside className="wd__left">
            <div className="wd__card">
              ...
              <div className="wd__card-msg">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="#1B4FBA" stroke="none"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/></svg>
                <span>Have a question?</span>
                <button type="button" className="wd__card-msg-link">Message {firstName}</button>
              </div>
            </div>
          </aside>
